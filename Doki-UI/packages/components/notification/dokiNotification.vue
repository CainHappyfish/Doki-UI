...
import {getLastOffset, getOffsetOrSpace} from "./instances.ts";

const notificationContainer = ref<HTMLDivElement | null>();
...
useResizeObserver(notificationContainer, () => {
  height.value = notificationContainer.value!.getBoundingClientRect().height;
});
...
<template>
  ...
  >
    <div
        :class="['doki-notification', type ? 'doki-notification__' + type : '', centerStyle]"
    ...
    >
      ...
      <div class="doki-notification__content">
        <slot>
